...
<body class="authentication-bg position-relative">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header pt-4 text-center">
                            <div class="auth-brand mb-0">
                                <a href="index.html" class="logo-dark">
                                    <span><img src="{{ asset('dashboard/assets/images/logo-dark.png') }}"
                                            alt="dark logo" height="28"></span>
                                </a>
                                <a href="index.html" class="logo-light">
                                    <span><img src="{{ asset('dashboard/assets/images/logo.png') }}" alt="logo"
                                            height="28"></span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4">Enter your email address and password to access your account.
                                </p>
                            </div>
                            ...
                            @endif
                                ...
                                <div class="mb-3 mb-0 text-center">
                                    <input type="submit" name="loginBtn" value='Log In' id="loginBtn"
    ...
    <footer class="footer footer-alt">
        <span class="text-white-50">
            ...
            </script> © Fronx Solution - fronxsolutions.com
        </span>
    </footer>
    <!-- Vendor js -->
