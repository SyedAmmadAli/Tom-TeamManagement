...
<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <div class="leftbar-user p-3 text-white">
            <a href="{{ route('profile') }}" class="d-flex align-items-center text-reset">
                <div class="flex-shrink-0">
                    ...
                    @else
                    <img src="{{ asset('dashboard/assets/images/users/avatar-1.jpg') }}" alt="user-image" height="42"
                    class="rounded-circle shadow border border-primary">
                    @endif
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#mediaGallery" aria-expanded="false" aria-controls="mediaGallery"
                    class="side-nav-link">
                    <i class="ri-list-check-3"></i>
                    <span> Media </span>
                    <span class="menu-arrow"></span>
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#AutoEnhanced" aria-expanded="false" aria-controls="AutoEnhanced"
                    class="side-nav-link">
                    <i class="ri-list-check-3"></i>
